...
function Register() {
  const { handleSubmit, handleChange, values, errors, isSubmitting, touched, handleBlur } = useFormik({
    initialValues: {
      fullname: "",
      username: "",
      email: "",
        ...
        <form onSubmit={handleSubmit} autoComplete="off">
          ...
          <div className="input-box">
            <div className="input-field">
              ...
              {touched.fullname && errors.fullname ? <p className="error">*{errors.fullname}</p>: null}
            </div>
            <div className="input-field">
              <input
                type="text"
              ...
              />
              <PersonIcon fontSize="small" className="user" />
              {touched.username && errors.username ?<p className="error">*{errors.username}</p>: null}
            </div>
          </div>
          ...
          <div className="input-box">
            ...
            <div className="input-field">
              ...
              />
              <LockIcon fontSize="small" className="user" />
              {touched.confirmpassword && errors.confirmpassword ? <p className="error">*{errors.confirmpassword}</p>: null}
            </div>
          </div>
